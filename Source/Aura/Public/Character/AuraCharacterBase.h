...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Combat")
	float BaseWalkSpeed = 600.0f; // Default base walk speed for the character
	...
	TObjectPtr<UMaterialInstance> DissolveMaterialInstance; // Material instance for the dissolve effect
